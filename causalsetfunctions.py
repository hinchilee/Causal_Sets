    ...
    if BHtype == 'Rindler':
        ...
        for spacedimension in range(1, len(diff)):
            if spacedimension == 2 or spacedimension == 3:
                a = (wrapAroundLength -
                     stcoord2[spacedimension] + stcoord1[spacedimension])
...
def compute_spacetimecuts_tube(d, rho2=10000, N_max=10000, b=3):
    ...
    ndimension = d - 1
    stV = (T_max-T_min)*(n_ball_volume(ndimension, R_max) -
                         n_ball_volume(ndimension, R_min))
    rho = N_max/stV
    #adjustedl = rho**(-1/d)
...
if __name__ == "__main__":
    ...
    #     d=dimension, rho2=3e19, N_max=9000, b=b)
    ...
    for dimension in dimensionList:
        ...
        boundsArray, adjusted_rho, l = compute_spacetimecuts_uniform_Rindler(
            d=dimension, rho2=1e20, N_max=000, b=4.1)
