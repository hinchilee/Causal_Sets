...
if __name__ == "__main__":
    ...
    # #Dynamic
    # dimension = 2
    # boundsArray, rho= compute_spacetimecuts_tube(d = dimension, rho2 = 1e20, N_max = 1000, b= 4)
    ...
    for dimension in dimensionList:
        ...
        boundsArray, adjusted_rho, l = compute_spacetimecuts_uniform_Rindler(d = dimension, rho2 = 10, N_max = 10000, b = 3)
